...
def _loadICM_tags(tags_path, header=True, separator=',', if_new_item="ignore",
    ...
    ICM_builder = IncrementalSparseMatrix_FilterIDs(preinitialized_col_mapper=preinitialized_col_mapper,
                                                    on_new_col="add",
...
class Movielens20MReader(DataReader):
    ...
    def _load_from_original_file(self):
        ...
        ICM_genres, tokenToFeatureMapper_ICM_genres, self.item_original_ID_to_index = _loadICM_genres(genres_path,
                                                                                                      header=True,
                                                                                                      separator=',',
                                                                                                      genresSeparator="|")
        ...
        ICM_tags, tokenToFeatureMapper_ICM_tags, _ = _loadICM_tags(tags_path, header=True, separator=',',
                                                                   if_new_item="ignore",
        ...
        URM_all, self.item_original_ID_to_index, self.user_original_ID_to_index, URM_timestamp = _loadURM_preinitialized_item_id(
            URM_path, separator=",",
